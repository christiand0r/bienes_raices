(() => {
  ...
  import_dropzone.Dropzone.options.formPropertyImage = {
    ...
    parallelUploads: 1,
    paramName: "images",
    dictDefaultMessage: "Arrastra y suelta tus im\xE1genes aqu\xED",
    dictRemoveFile: "Borrar imagen",
    dictMaxFilesExceeded: "El m\xE1ximo de im\xE1genes que puede subir es 1",
    headers: {
      "X-CSRF-Token": token
    },
    init() {
